...
/**
 * Migration test for v60 → v61 — `medication_tier_states` gains
 * `intended_time` (nullable) + `logged_at` (NOT NULL, backfilled from
 * `updated_at`); new `medication_marks` table created.
 *
 * Pre-migration setup mirrors the v60 shape: `medications`,
 * `medication_slots`, and the `medication_tier_states` table created
 * by `MIGRATION_59_60`.
 */
        ...
        val config = SupportSQLiteOpenHelper.Configuration.builder(
            ...
            .callback(object : SupportSQLiteOpenHelper.Callback(60) {
                override fun onCreate(db: androidx.sqlite.db.SupportSQLiteDatabase) {
                    ...
                    // medication_tier_states v60 shape — pre-additive columns.
                    db.execSQL(
