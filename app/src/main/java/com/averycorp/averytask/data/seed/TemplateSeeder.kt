package com.averycorp.averytask.data.seed
 ...
 */
@Singleton
class TemplatePreferencesSeededFlagStore @Inject constructor(
 ...
 * back to `false` by [com.averycorp.averytask.data.repository.TaskTemplateRepository]
...
class TemplateSeeder @Inject constructor(
     ...
     *
     * The production binding in [com.averycorp.averytask.di.DatabaseModule]
