 ...
 *
 * This is independent of the Firebase [com.averycorp.averytask.data.remote.SyncService]
...
class BackendSyncService @Inject constructor(
    ...
    private fun taskToOperation(task: TaskEntity): SyncOperation {
    ...
    private fun projectToOperation(project: ProjectEntity): SyncOperation {
        val data = JsonObject().apply {
    ...
    private fun tagToOperation(tag: TagEntity): SyncOperation {
        val data = JsonObject().apply {
    ...
    private fun habitToOperation(habit: HabitEntity): SyncOperation {
        val data = JsonObject().apply {
    ...
    private fun habitCompletionToOperation(completion: HabitCompletionEntity): SyncOperation {
        val data = JsonObject().apply {
